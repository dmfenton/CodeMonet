...
3. Categorize files by area (server/, web/, shared/, ios/)

### Pass 2: Automated Checks

1. Backend: `make lint-server && make typecheck-server`
2. Frontend: `make lint-web && make typecheck-web`
3. iOS (if ios/ changed): `make ios-kit-test`
4. Report any failures before proceeding
